...
class Admin::PostsControllerTest < ActionController::TestCase
  ...
  test "should create admin_post" do
    assert_difference('Admin::Post.count') do
      post :create, admin_post: { admin_category_id: @admin_post.admin_category_id, message: @admin_post.message, name: @admin_post.name, resume: @admin_post.resume }
    end
  ...
  test "should update admin_post" do
    patch :update, id: @admin_post, admin_post: { admin_category_id: @admin_post.admin_category_id, message: @admin_post.message, name: @admin_post.name, resume: @admin_post.resume }
    assert_redirected_to admin_post_path(assigns(:admin_post))
  end
